...
function IconSettings({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none">
      ...
      />
      <path
        d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09a1.65 1.65 0 0 0-1-1.51 1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09c.7 0 1.26-.4 1.51-1a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06c.5.5 1.14.77 1.82.33.46-.28 1-.44 1.51-.44H11a2 2 0 0 1 4 0h.09c.51 0 1.05.16 1.51.44.68.44 1.32.17 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06c-.5.5-.77 1.14-.33 1.82.28.46.44 1 .44 1.51V9a2 2 0 0 1 0 4h-.09c-.7 0-1.26.4-1.51 1z"
        stroke="currentColor"
        strokeWidth="1.25"
        strokeLinecap="round"
        strokeLinejoin="round"
    ...
    <aside className="w-64 min-h-screen sticky top-0 px-6 py-6 bg-[#0d0d0f] flex flex-col">
      ...
      <div className="mb-4">
        <label className="relative block">
          ...
          <input
            className="w-full bg-transparent border border-white/10 rounded-md py-2 pl-10 pr-3 text-sm placeholder:text-gray-500 text-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-600"
            placeholder="Search"
            type="search"
          />
        </label>
      ...
      <nav className="space-y-2 flex-1">
        <NavItem href="/teacher/dashboard" label="Dashboard" icon={<IconGrid />} pathname={pathname} />
        <NavItem href="/teacher/quizzes" label="Quizzes" icon={<IconBook />} pathname={pathname} />
        <NavItem href="/teacher/events" label="Events" icon={<IconCalendar />} pathname={pathname} />
        <NavItem href="/teacher/students" label="Students" icon={<IconUsers />} pathname={pathname} />
      </nav>
